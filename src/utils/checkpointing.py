...
Provides robust checkpointing for interrupted training recovery,
essential for Google Colab where sessions can be interrupted.
"""
...
def save_checkpoint(
    ...
    Args:
        ...
        name: Checkpoint filename prefix
...
class CheckpointManager:
    """
    Manager for handling checkpoints with automatic cleanup.
    
    Keeps only the N best and M most recent checkpoints to save storage.
    """
    ...
    def _cleanup(self):
        ...
        # Keep track of what to preserve
