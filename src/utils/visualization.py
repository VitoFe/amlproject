...
Provides functions for plotting training curves, comparisons,
and other experiment visualizations.
"""
...
def plot_heterogeneity_comparison(
    ...
    Args:
        results: Dict mapping method name to {nc: metric_value}
        nc_values: List of Nc values tested
...
def plot_local_steps_comparison(
    ...
    Args:
        results: Dict mapping local_steps to metrics dict
        local_steps: List of J values tested
        metric: Metric to compare
        title: Plot title
        save_path: Optional save path
        figsize: Figure size
...
def plot_sparsity_comparison(
    ...
    Args:
        results: Dict mapping sparsity ratio to metrics
        sparsity_ratios: List of sparsity values tested
        metric: Metric to compare
        title: Plot title
        save_path: Optional save path
        figsize: Figure size
