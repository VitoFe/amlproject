...
Runs FedAvg experiments on CIFAR-100 with DINO ViT-S/16.
Supports IID and non-IID data sharding with configurable heterogeneity.

Usage:
    python scripts/train_federated.py --num-clients 100 --participation-rate 0.1 --local-steps 4
    python scripts/train_federated.py --sharding non_iid --nc 5
"""
...
def main():
    ...
    # Heterogeneity experiment: vary Nc values
    ...
    # Local steps experiment: vary J values
    if args.local_steps_experiment:
        ...
        for j in args.j_values:
            ...
            # Adjust rounds to maintain similar compute  
