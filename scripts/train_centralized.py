...
Runs the centralized baseline experiment on CIFAR-100 with DINO ViT-S/16.
This serves as the benchmark for federated learning approaches.

Usage:
    python scripts/train_centralized.py --epochs 50 --lr 0.001
"""
