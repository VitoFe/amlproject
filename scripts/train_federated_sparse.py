"""
Federated Sparse Fine-tuning Training Script

Runs federated learning experiments with task arithmetic techniques:
sparse fine-tuning using gradient masks based on parameter sensitivity.

Usage:
    python scripts/train_federated_sparse.py --sparsity-ratio 0.9 --mask-strategy least_sensitive
    python scripts/train_federated_sparse.py --compare-strategies
"""
...
def run_single_experiment(args, sparsity_ratio=None, mask_strategy=None, run=0):
    """Run a single federated sparse training experiment."""
...
def main():
    ...
    # Sparsity experiment: vary sparsity ratios
