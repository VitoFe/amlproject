...
Main entry point for the project. This module provides convenient
...
Examples:
    ...
    train_parser.add_argument('--sharding', type=str, default='iid',
                             choices=['iid', 'non_iid'])
    ...
    runall_parser.add_argument('--quick', action='store_true',
                              help='Quick test run')
    runall_parser.add_argument('--full', action='store_true',
                              help='Full experiments')
    ...
    if args.command == 'train':
        if args.mode == 'centralized':
            ...
            sys.argv = ['train_federated_sparse.py',
                       '--num-clients', str(args.num_clients),
                       '--num-rounds', str(args.num_rounds),
                       '--sparsity-ratio', str(args.sparsity_ratio),
